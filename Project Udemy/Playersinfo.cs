...
namespace Project_Udemy
{
    ...
    {
        private static string playersInfoDirectory = @"Info";
        ...
        public static void Initialize(List<Character> characters, FileInfo playersInfoFile, List<Character> characters)
        {
            ...
            using (StreamWriter sr = playersInfoFile.OpenText())
            {
        ...
        public static void RetrieveFullInfo(List<Character> characters)
        {

        }
        public static void PrintfFullInfo(List<Character> characters)
        {
